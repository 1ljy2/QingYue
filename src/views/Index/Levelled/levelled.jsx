...
export default function Levelled() {
      ...
      <Layout className='layout-in'>
        <Content className='content-in'>
          ...
          <div className='modern2'>
            <Link className='txt' to='/levelled/txt' state={{ level: level }}>
              <div className='word'>
                <h3>段落阅读</h3>
                <p>上传英文段落，</p>
                <p>实现分级化阅读</p>
            ...
            <Link className='wd' to='/levelled/wd' state={{ level: level }}>
              <div className='word'>
                <h3>文档阅读</h3>
                <p>上传英文文档，</p>
                <p>自动解析便于阅读</p>
            ...
            <Link className='pic' to='/levelled/pic' state={{ level: level }}>
              <div className='word'>
                <h3>图片阅读</h3>
                <p>上传文字图片，</p>
                <p>解析并阅读轻便化</p>
