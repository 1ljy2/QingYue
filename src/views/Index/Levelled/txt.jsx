...
export default function Txt() {
  ...
  const submit = () => {
    console.log(level)
    console.log(text)
    // http://localhost:8070/three_simple_context/paragragh
    // action: 'https://httpbin.org/post',
    axios
      .post(
        'http://0.0.0.0:8070/three_simple_context/paragragh',
        {
          level: 'level',
          text: 'text',
        },
    ...
    <>
      ...
      <div className={styles.exam}>
        <div className={styles.exam1}>
          ...
          <button onClick={() => tryClick1()} className={styles.btn1}>
            去试试
          </button>
        </div>
        <div className={styles.exam2}>
          ...
          <button onClick={() => tryClick2()} className={styles.btn2}>
            去试试
          </button>
        </div>
      </div>
